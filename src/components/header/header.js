    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div className="container">
          <a className="navbar-brand" href="https://www.google.com">Start Bootstrap</a>
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item active">
                <a className="nav-link" href="https://www.google.com"><Link to="/" className="link">
                  Home
                </Link></a>
              </li>
              ...
              <li className="nav-item">
                <a className="nav-link" href="https://www.google.com"><Link to="/chathome" className="link">
                  Chat
                </Link></a>
              </li>
              <li className="nav-item">
