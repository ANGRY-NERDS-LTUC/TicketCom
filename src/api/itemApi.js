...
export const getItems = () => {
  return fetch(`https://store-server-saleh.herokuapp.com/items`, {
    method: 'GET',
  })
    .then((response) => {
...
export const getOneItem = async (itemId) => {
  const result = await axios.get(
    `https://store-server-saleh.herokuapp.com/items/${itemId}`,
    {},
  );
  return result.data;
};
...
export const createItem = async (userId, token, data) => {
  const result = await axios.post(
    `https://store-server-saleh.herokuapp.com/items/${userId}`,
    data,
    {
      headers: {
...
export const getUserItems = async (userId, token) => {
  try {
    const resp = await axios.get(
      `https://store-server-saleh.herokuapp.com/items/userItems/${userId}`,
      {
        headers: {
          Accept: 'application/json',
          Authorization: `Bearer ${token}`,
...
export const updateItem = async (userId, itemId, token, data) => {
  ...
  const result = await axios.put(
    `https://store-server-saleh.herokuapp.com/items/${itemId}/${userId}`,
    data,
    {
      headers: {
        Accept: 'application/json',
...
export const getUserFavorites = async (userId, token) => {
  try {
    const resp = await axios.get(
      `https://store-server-saleh.herokuapp.com/favourites/${userId}`,
      {
        headers: {
          Accept: 'application/json',
          Authorization: `Bearer ${token}`,
...
export const addToFavourite = (itemId, userId, token) => {
  return fetch(
    `https://store-server-saleh.herokuapp.com/favourites/${itemId}/${userId}`,
    {
      method: 'POST',
      headers: {
        Accept: 'application/json',
...
export const removeFromFavourite = (favouriteId, userId, token) => {
  ...
  return fetch(
    `https://store-server-saleh.herokuapp.com/favourites/${favouriteId}/${userId}`,
    {
      method: 'DELETE',
      headers: {
        Accept: 'application/json',
...
export const getUserCart = async (userId, token) => {
  try {
    const resp = await axios.get(
      `https://store-server-saleh.herokuapp.com/cart/${userId}`,
      {
        headers: {
          Accept: 'application/json',
          Authorization: `Bearer ${token}`,
...
export const addToCart = (itemId, userId, token) => {
  return fetch(
    `https://store-server-saleh.herokuapp.com/cart/${itemId}/${userId}`,
    {
      method: 'POST',
      headers: {
        Accept: 'application/json',
...
export const removeFromCart = (cartId, userId, token) => {
  ...
  return fetch(
    `https://store-server-saleh.herokuapp.com/cart/${cartId}/${userId}`,
    {
      method: 'DELETE',
      headers: {
        Accept: 'application/json',
